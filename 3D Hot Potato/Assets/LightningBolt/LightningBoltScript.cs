...
namespace DigitalRuby.LightningBolt
{
    ...
    public class LightningBoltScript : MonoBehaviour
    {
		/*
		 * 
		 * Added stuff to make the lightning follow the players, destroy enemies it touches,
        ...
        private void Update()
        {
			...
			//added stuff
			StartObject.transform.position = player1.transform.position;
			EndObject.transform.position = player2.transform.position;
		...
		//added so that this can be turned on and off
